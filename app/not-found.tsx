	...
	return (
		<div className='min-h-screen flex flex-col items-center justify-center px-4'>
			<div className='text-center max-w-md'>
				<h1 className='text-8xl md:text-9xl font-light font-[family-name:var(--font-newsreader)] text-accent mb-4'>
					404
				</h1>
				...
				<Link
					href='/'
					className='inline-block px-6 py-3 bg-accent text-background font-medium hover:bg-accent-dark transition-colors'
				>
					← Back to Home
				</Link>
			</div>
